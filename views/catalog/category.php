                ...
                <div class="row">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
                                            ...
                                            class=<?php if($CategoriesItem['id']==$categoryId){echo "active";} ?>
                                            >
                    ...
                    <div class="col-sm-9 padding-right">
                        <div class="features_items"><!--features_items-->
                            ...
                            <div class="col-sm-4">
                            <?php foreach ($CategoryProducts1 as $productItem): ?>
                            ...
                            <div class="col-sm-4">
                            <?php foreach ($CategoryProducts2 as $productItem): ?>
                            ...
                            <div class="col-sm-4">
                            <?php foreach ($CategoryProducts3 as $productItem): ?>
